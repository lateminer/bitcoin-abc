...
static const unsigned int MAX_OP_RETURN_RELAY_LARGE = 15000;
...
static const uint32_t MANDATORY_SCRIPT_VERIFY_FLAGS =
    SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_DERKEY | SCRIPT_VERIFY_LOW_S |
    SCRIPT_VERIFY_NULLDUMMY | SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY | SCRIPT_VERIFY_DERSIG;
